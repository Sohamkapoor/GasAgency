<%-- 
    ...
    Created on : Nov 14, 2016, 10:53:23 AM
    Author     : sohamkapoor
--%>
...
<html>
    ...
    <body>
        ...
        <tr> <td> <h3>PinCode :</h3> </td> <td> <%= pin %> </td></tr>
        <% if(telephone.equals("")){} else{%>
        <tr> <td> <h3>Telephone :</h3> </td><td><%= telephone %><%}%></td></tr>
        <tr> <td><h3>Mobile Number:</h3></td><td> <%= mobile %></td></tr>
        ...
        <tr> <td><h3>Adhar Number :</h3></td><td> <%= adharno %><%}%></td></tr>
        <% if(pan.equals("")){} else{%>
        <tr> <td><h3>Pan Number :</h3></td><td> <%= pan %><%}%></td> </tr>
        <% if(dl.equals("")){} else{%>
        ...
        <tr> <td><h3>State & Central ID :</h3></td><td> <%= state %><%}%></td></tr>
       <% try{
